...
let count=numberAsString.length; // numberAsString sutekstinam reiksme. const numberAsString=''+n; tu parduoti skaiciu o jis tampa'skaicius';
// 5
// 159
/// 123456
 if (n%1!==0){ // jeigu padalinam be liekanos ir gauna 0.11 po kalbelio reiskias atimam. 
    count --;
 }
 if (n<0){ // ar skaicius ne minusinis. 
    count --;
 }
