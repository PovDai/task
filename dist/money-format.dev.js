...
console.log(moneyFormat(3)); /// jeigu be fixed padaryti ats.

function moneyFormat2(money) {
  // is money reikia gauti dali po kalbelio
  var decimalPart = (money - Math.floor(money)) * 100; // turime desimtaine dali  // 0.1 
...
function moneyFormat3(money) {
  var strMoney = '' + money; /// taip pakeite i string eilute is number. 

  var dotPosition = strMoney.indexOf('.'); /// tasko vieta gauname kad zinoti kiek po kablelio reiks. 
  ...
  var afterDot = strMoney.slice(dotPosition + 1); // nes imam nuo tasko 
